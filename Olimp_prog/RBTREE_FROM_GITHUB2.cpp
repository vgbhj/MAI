...
inline int DeleteCase3(Node *&root, Node *&sibling, Node *&parent, Node *&pointer)
{
    ...
    else if (GetColor(sibling) != Color::Red)
    {
        ...
        else if (GetColor(sibling->Left) != Color::Black || GetColor(sibling->Right) != Color::Black)
        {
...
void FixDeleteRBTree(Node *&root, Node *&node)
{
    ...
    else if (GetColor(node) != Color::Red && GetColor(node->Left) != Color::Red && GetColor(node->Right) != Color::Red)
    {
